...
class SpriteObject(pg.sprite.Sprite):
    ...
    """
    def __init__(self, name, save=True, position=[0, 0], image=pg.Surface((16, 16)), d_sprites=False, visible=True, zOrder=0):
        """
        ...
        self.image = image
        if d_sprites: self.d_sprites = load_sprites(name)
        else: self.d_sprites = d_sprites
